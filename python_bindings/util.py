...
cuda_extra_cuda_cflags = ["-O3",  "--use_fast_math", "--expt-extended-lambda", "-std=c++20", " --expt-relaxed-constexpr", "-DNDEBUG", profiler_sync_extra]  # , "-DNDEBUG"
if platform.system() == "Windows":
    ...
    cuda_extra_cuda_cflags.append(f"-Xcompiler -fopenmp -DNDEBUG {profiler_sync_extra} -DGLM_FORCE_XYZW_ONLY -DGLM_ENABLE_EXPERIMENTAL")  #  -DNDEBUG"
